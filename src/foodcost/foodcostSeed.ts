...
export const DEFAULT_INGREDIENTS: SeedIngredient[] = [
  ...
  { id: 'cafe_grains', name: 'Café en grains', unit: 'kg', unitPrice: 120 },
  ...
  { id: 'eau_bouteille_33cl', name: "Bouteille d'eau 33cl", unit: 'stuk', unitPrice: 1.8 },
  { id: 'oulmes_bouteille', name: 'Bouteille Oulmès', unit: 'stuk', unitPrice: 6 },
  { id: 'canette_coca', name: 'Canette Coca-Cola', unit: 'stuk', unitPrice: 6 },
  { id: 'canette_coca_zero', name: 'Canette Coca-Cola Zero', unit: 'stuk', unitPrice: 6 },
  { id: 'canette_sprite', name: 'Canette Sprite', unit: 'stuk', unitPrice: 6 },
  { id: 'canette_poms', name: 'Canette Poms', unit: 'stuk', unitPrice: 6 },
  ...
  { id: 'canette_hawaii', name: 'Canette Hawaii', unit: 'stuk', unitPrice: 5.5 },
  ...
  { id: 'croissant_premade', name: 'Croissant (préfabriqué)', unit: 'stuk', unitPrice: 4.5 },
  { id: 'pain_choc_premade', name: 'Pain au chocolat (préfabriqué)', unit: 'stuk', unitPrice: 5 },
  { id: 'pain_raisins_premade', name: 'Pain aux raisins (préfabriqué)', unit: 'stuk', unitPrice: 5.5 },
  ...
  // Fromages / laitier
  { id: 'mozzarella', name: 'Mozzarella', unit: 'kg', unitPrice: 75 },
  { id: 'edam', name: 'Edam', unit: 'kg', unitPrice: 70 },
  { id: 'cheddar', name: 'Cheddar', unit: 'kg', unitPrice: 85 },
  { id: 'bleu', name: 'Fromage bleu', unit: 'kg', unitPrice: 110 },
  ...
  // Légumes / fruits
  { id: 'tomate', name: 'Tomate', unit: 'kg', unitPrice: 6 },
  { id: 'oignon', name: 'Oignon', unit: 'kg', unitPrice: 5 },
  { id: 'laitue', name: 'Laitue', unit: 'kg', unitPrice: 10 },
  { id: 'cornichons', name: 'Cornichons', unit: 'kg', unitPrice: 35 },
  { id: 'olives_noires', name: 'Olives noires', unit: 'kg', unitPrice: 40 },
  { id: 'poivrons', name: 'Poivrons', unit: 'kg', unitPrice: 10 },
  { id: 'champignons', name: 'Champignons', unit: 'kg', unitPrice: 30 },
  { id: 'pommes_de_terre', name: 'Pommes de terre', unit: 'kg', unitPrice: 4 },
  { id: 'betteraves', name: 'Betteraves', unit: 'kg', unitPrice: 6 },
  { id: 'carottes', name: 'Carottes', unit: 'kg', unitPrice: 5 },
  { id: 'concombre', name: 'Concombre', unit: 'kg', unitPrice: 6 },
  ...
  { id: 'basilic', name: 'Basilic', unit: 'kg', unitPrice: 60 },
