...
export const translations = {
  en: {
    meta_title: "Dom's Café & Restaurant | Order on WhatsApp",
    ...
    hero_cta_primary: "Explore Menu & Order via WhatsApp",
    ...
    menu_subtitle: "Assemble your order below. When ready, click checkout to send your order directly to our kitchen via WhatsApp.",
    ...
    checkout_modal_notice: "Confirm your order. You will then be redirected to WhatsApp to send your order to the restaurant.",
    checkout_modal_confirm_btn: "Confirm and send to WhatsApp",
    ...
    pizza_crust_classic: "",
    pizza_crust_thin: "",
    cart_confirm_dine_in: "Order sent. Proceed to the WhatsApp checkout, we will bring everything to your table.",
    cart_confirm_delivery: "Order sent. We will confirm with you on WhatsApp.",
  ...
  fr: {
    meta_title: "Dom's Café & Restaurant | Commandez sur WhatsApp",
    ...
    hero_cta_primary: "Explorer le Menu & Commander via WhatsApp",
    ...
    menu_subtitle: "Composez votre commande ci-dessous. Une fois prêt, validez pour envoyer vos choix directement à notre cuisine via WhatsApp.",
    ...
    checkout_modal_notice: "Confirmez votre commande. Vous serez ensuite redirigé vers WhatsApp pour envoyer la commande au restaurant.",
    checkout_modal_confirm_btn: "Confirmer et envoyer vers WhatsApp",
    ...
    pizza_crust_classic: "",
    pizza_crust_thin: "",
    cart_confirm_dine_in: "Commande envoyée. Passez à la caisse WhatsApp pour régler, on vous apporte tout à table.",
    cart_confirm_delivery: "Commande envoyée. On vous confirme sur WhatsApp.",
  ...
  ar: {
    meta_title: "دومز كافيه ومطعم | اطلب عبر الواتساب",
    ...
    hero_cta_primary: "تصفح القائمة واطلب عبر الواتساب",
    ...
    menu_subtitle: "قم بتركيب طلبك أدناه. عندما تصبح جاهزًا، اضغط على زر إرسال الطلب ليتم إرساله مباشرة لمطبخنا عبر رسالة واتساب.",
    ...
    checkout_modal_notice: "تأكيد طلبك. سيتم توجيهك بعد ذلك إلى الواتساب لإرسال الطلب إلى المطعم.",
    checkout_modal_confirm_btn: "تأكيد والإرسال إلى واتساب",
    ...
    pizza_crust_classic: "",
    pizza_crust_thin: "",
    cart_confirm_dine_in: "تم إرسال الطلب. يرجى إتمام الدفع عبر كاشير الواتساب، وسنحضر كل شيء إلى طاولتك.",
    cart_confirm_delivery: "تم إرسال الطلب. سنقوم بالتأكيد معك عبر الواتساب.",
